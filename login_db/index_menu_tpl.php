<img src="/SENAC-TSI-PHP-2020-2/login_db/usuario/view/imagens/<?php echo $foto; ?>">

<div class="container text-center text-white pt-sm-2">
	<!-- <?php echo "Seja Muito Bem-Vindo! ". $_SESSION['login']."<br>"; ?> -->

	<a class="text-dark" href="/Github/SENAC-TSI-PHP-2020-2/login_db/nps_tpl.php"><input type='button' class='btn btn-outline-dark' name='mnNps' value='NPS'></a>
	
	<a class="text-dark" href="/Github/SENAC-TSI-PHP-2020-2/login_db/qualquer.php"><input type='button' class='btn btn-outline-dark' name='mnQualquer' value='Qualquer'></a>
